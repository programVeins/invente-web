...
export default component$(() => {
  ...
  return (
    <div class="grid w-1/2 mx-auto my-20 grid-cols-4 text-white font-azonix text-3xl place-items-center">
      <div class="h-28 w-28 flex items-center justify-center border-[0.02rem] border-gray-400 border-opacity-20 bg-black/20 rounded-xl backdrop-blur-lg">
        <p>{store.daysDiff}</p>
